...
class Person():
    ...
    def getLastName(name):  #last name is always last word in name
      x = 0
      while name[x] is not ' ':
        x--
      x++ #go back to after ' '
    ...
    def getFirstName(name): #first name may have middle initial. Easiest to return everything except last name
